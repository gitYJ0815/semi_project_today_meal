		...
		<div class="contents">
			<div class="contents_inner">
				...
				<div class="search_area">
					<div>
						<label for="select_year">기간 : </label>
					...
					<div>
						<div>
							...
							<input type="text" name="find_id" id="find_id" placeholder="아이디 입력">
						</div>
						<div>
							<label for="find_order_number">주문 번호 : </label>
							<input type="text" name="find_order_number" id="find_order_number" placeholder="주문번호 입력">
						</div>
					</div>
