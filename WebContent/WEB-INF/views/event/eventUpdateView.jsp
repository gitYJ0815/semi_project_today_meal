...
<body>
	...
	<div id="container">
		<h2 id="title" style="font-weight:bold; font-size:20px;">이벤트 게시판 관리</h2>
		<div class="board_content">
			<form method="post" action="${ contextPath }/event/update" enctype="multipart/form-data">
			<input type="hidden" name="eno" value="${ e.eno }">
				<div class="content">
					<div class="titleArea">
						<h4>제목<span id="require">*</span><span class="input_area" style="margin-left : 40px;">
						<input type="text" name="title" required value="${e.event_title }"></span></h4><br>
					</div>
					<div>
					기간 <span id="require">*</span>&nbsp;&nbsp;
					<span class="select_term" style="margin-left : 30px;">
					<span class="input_area" style="margin-left : 5px;">
						<input type="text" name="term" value="${e.term }" required></span>
					</span>
					</div>
					...
					<div id="event_img">
						<!-- 이미지 담는 div-->
						<img src="../resources/uploadFiles/event/${e.content }" style="width:900px; height:1000px">
					</div>
				</div>
