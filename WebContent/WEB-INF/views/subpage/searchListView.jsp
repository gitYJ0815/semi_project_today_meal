...
<body>
	...
	<div id="container">
		<div class="contents">
			<h2>'${ searchBox }' 검색 결과</h2>
			<div class="result_option">
				<ul>
					<li <c:if test="${ empty param.st || param.st == 'recent' }">class="active"</c:if>><a href="${ contextPath }/search/list?searchBox=${ searchBox }&st=recent">최신순</a></li>
					<li <c:if test="${ param.st == 'satisfaction' }">class="active"</c:if>><a href="${ contextPath }/search/list?searchBox=${ searchBox }&st=satisfaction">별점 높은순</a></li>
					<li <c:if test="${ param.st == 'hightprice' }">class="active"</c:if>><a href="${ contextPath }/search/list?searchBox=${ searchBox }&st=hightprice">높은 가격순</a></li>
					<li <c:if test="${ param.st == 'lowprice' }">class="active"</c:if>><a href="${ contextPath }/search/list?searchBox=${ searchBox }&st=lowprice">낮은 가격순</a></li>
				</ul>
			</div>
			...
			<div class="paging">
				...
				<jsp:include page="/WEB-INF/views/common/paging/paging.jsp">
					<jsp:param name="url" value="${ contextPath }/search/list?searchBox=${ searchBox }&"/>
