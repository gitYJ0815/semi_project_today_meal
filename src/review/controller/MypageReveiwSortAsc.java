...
/**
 * Servlet implementation class MypageReveiwSortAsc
 */
@WebServlet("/mypage/reviewAsc")
public class MypageReveiwSortAsc extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageReveiwSortAsc() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Product product = new ProductService().selectMyProductAsc(userNo);
